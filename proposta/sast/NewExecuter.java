...
public class NewExecuter {
	...
	public static void main(String[] args) throws IOException, InterruptedException {
		...
		for(int ec=3; ec<=estudos_caso; ec++){
			...
			for(int trial=0; trial<maxTrials; trial++) {
				System.out.println("Algoritmo: MOMBI Contagem de execução: "+trial);
			...
			for(int trial=0; trial<maxTrials; trial++) {
				System.out.println("Algoritmo: SPEA2 Contagem de execução: "+contagem_solucao);
			...
			for(SolucaoIndividual solucaoSPEA2_ : popsFinais.getAllpopSPEA2TodoMundoMesmo()){		
				...
				System.out.println("---------------------------");
				System.out.println("Solução "+solucaoSPEA2_.getHypervolume().size());
				System.out.println("---------------------------");
				...
				Writer writer_hyp_SPEA2 = Files.newBufferedWriter(Paths.get("C:\\Users\\camil\\eclipse-workspace\\metaheuristic\\files\\resultados_hyp_SPEA2.csv"), StandardOpenOption.APPEND);
				...
				Writer writer_eps_SPEA2 = Files.newBufferedWriter(Paths.get("C:\\Users\\camil\\eclipse-workspace\\metaheuristic\\files\\resultados_eps_SPEA2.csv"), StandardOpenOption.APPEND);
				...
				Writer writer_igd_SPEA2 = Files.newBufferedWriter(Paths.get("C:\\Users\\camil\\eclipse-workspace\\metaheuristic\\files\\resultados_igd_SPEA2.csv"), StandardOpenOption.APPEND);
			...
			for(SolucaoIndividual solucaoMOMBI2_ : popsFinais.getAllpopMOMBITodoMundoMesmo()){		
				...
				Writer writer_hyp_MOMBI2 = Files.newBufferedWriter(Paths.get("C:\\Users\\camil\\eclipse-workspace\\metaheuristic\\files\\resultados_hyp_MOMBI2.csv"), StandardOpenOption.APPEND);
				...
				Writer writer_eps_MOMBI2 = Files.newBufferedWriter(Paths.get("C:\\Users\\camil\\eclipse-workspace\\metaheuristic\\files\\resultados_eps_MOMBI2.csv"), StandardOpenOption.APPEND);
				...
				Writer writer_igd_MOMBI2 = Files.newBufferedWriter(Paths.get("C:\\Users\\camil\\eclipse-workspace\\metaheuristic\\files\\resultados_igd_MOMBI2.csv"), StandardOpenOption.APPEND);
			...
			for(SolucaoIndividual solucaoNSGAIII_ : popsFinais.getAllpopNSGAIIITodoMundoMesmo()){		
				...
				Writer writer_hyp_NSGAIII = Files.newBufferedWriter(Paths.get("C:\\Users\\camil\\eclipse-workspace\\metaheuristic\\files\\resultados_hyp_NSGAIII.csv"), StandardOpenOption.APPEND);
				...
				Writer writer_eps_NSGAIII = Files.newBufferedWriter(Paths.get("C:\\Users\\camil\\eclipse-workspace\\metaheuristic\\files\\resultados_eps_NSGAIII.csv"), StandardOpenOption.APPEND);
				...
				Writer writer_igd_NSGAIII = Files.newBufferedWriter(Paths.get("C:\\Users\\camil\\eclipse-workspace\\metaheuristic\\files\\resultados_igd_NSGAIII.csv"), StandardOpenOption.APPEND);
			...
			for(SolucaoIndividual solucaoIBEA_ : popsFinais.getAllpopIBEATodoMundoMesmo()){		
				...
				Writer writer_hyp_IBEA = Files.newBufferedWriter(Paths.get("C:\\Users\\camil\\eclipse-workspace\\metaheuristic\\files\\resultados_hyp_IBEA.csv"), StandardOpenOption.APPEND);
				...
				Writer writer_eps_IBEA = Files.newBufferedWriter(Paths.get("C:\\Users\\camil\\eclipse-workspace\\metaheuristic\\files\\resultados_eps_IBEA.csv"), StandardOpenOption.APPEND);
				...
				Writer writer_igd_IBEA = Files.newBufferedWriter(Paths.get("C:\\Users\\camil\\eclipse-workspace\\metaheuristic\\files\\resultados_igd_IBEA.csv"), StandardOpenOption.APPEND);
