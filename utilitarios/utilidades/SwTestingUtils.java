	    	...
	    	for (int ind: solution){
	       	...
	       	for (List<String> sc: allDecisionVariables){
	       		for(String string : sc) {
	       			if(string.contains("final") || string.contains("else_") || string.contains("switch_") || string.contains("while_") || string.contains("case_") || string.contains("return")) {
	       				executionEffort = executionEffort+2;	       				
	       			}else {
