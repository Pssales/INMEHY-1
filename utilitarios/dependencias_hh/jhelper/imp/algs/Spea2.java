package  dependencias_hh.jhelper.imp.algs;

import  dependencias_hh.imp.llhs.SPEA2;
import  dependencias_hh.jhelper.core.DoubleTaggedSolution;
import  dependencias_hh.jhelper.core.OpManager;
import  dependencias_hh.jhelper.core.TaggedSolution;
import  dependencias_hh.jhelper.core.interfaces.ArchivedMetaheuristic;
...
public class Spea2<S extends Solution<?>> extends SPEA2<S> implements
   ...
   */
  protected EnvironmentalSelection_spea myenvironmentalSelection;
  /**
   * Archive size.
   */
  ...
  public Spea2(Problem<S> problem, int maxIterations, int populationSize,
    ...
    this.myenvironmentalSelection = new EnvironmentalSelection_spea(populationSize);
  ...
  public void setEnvironmentalSelectionSize(int size) {
    ...
    this.myenvironmentalSelection = new EnvironmentalSelection_spea<>(size);
  }
