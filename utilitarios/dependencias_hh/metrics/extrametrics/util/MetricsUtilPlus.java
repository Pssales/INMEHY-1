...
package dependencias_hh.metrics.extrametrics.util;

import java.io.*;
import java.util.*;

import dependencias_abstract.DefaultDoubleSolution;
...
//merge two fronts(SolutionSet)
    ...
    public List<S> vector2SolutionSet(double[][] front, Problem problem) {
        ...
        for (int i = 0; i < front.length; i++) {
            DefaultDoubleSolution sol = new DefaultDoubleSolution((DefaultDoubleSolution) problem);
